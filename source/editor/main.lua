...
function editor.changeView()
	--FIXME: We shouldn't change the Y offset at all, but 3DS crashes when there's more than 9 full length lines of 2-digit tile values on the screen with "detailed" view.
	...
	if editor.view.name == "normal" then
		...
		editor.view.y_offset = 96
	else
		editor.view.name = "normal"

		editor.view.y_offset = 32
	end
