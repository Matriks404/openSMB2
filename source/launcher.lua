...
function launcher.loadFonts()
	...
	launcher.font_normal = love.graphics.newImage(directory.."dogica.t3x")
	launcher.font_bold = love.graphics.newImage(directory.."dogica_bold.t3x")
end
...
function launcher.loadGraphics()
	...
	-- These are mandatory.
	local list = {
		["gp_good"] = { directory.."gamepack_good.t3x", true },
		["gp_bad"] = { directory.."gamepack_bad.t3x", true }
	}
